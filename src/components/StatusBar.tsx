...
export default function StatusBar() {
  return (
    <div className="fixed top-16 md:top-24 left-0 right-0 z-[150] pointer-events-none block">
      <div className="max-w-[1800px] mx-auto px-6 py-2 md:px-8 md:py-2.5 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-4 text-[9px] font-mono text-ghost/20 uppercase tracking-widest">
